    ...
    >
      ...
      >
        ...
        <div className="flex h-full">
          ...
          <button onClick={onClose} className="w-[45px] h-full flex items-center justify-center hover:bg-[#e81123] hover:text-white text-gray-400 transition-colors rounded-tr">
